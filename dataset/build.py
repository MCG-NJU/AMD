...
from .datasets import VideoClsDataset, SSRawFrameClsDataset, VideoMAE_SSV2,  VideoMAE
    ...
    def __init__(self, args):
        ...
        if args.mask_type == 'random':
            ...
            self.masked_position_generator = TemporalConsistencyMaskingGenerator(
                args.window_size, args.mask_ratio, args.mask_ratio_teacher
            )
